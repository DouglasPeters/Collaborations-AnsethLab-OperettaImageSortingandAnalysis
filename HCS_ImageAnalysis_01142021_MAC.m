...
InFocus_ImageSave = 1; %Do you want to save the in-focus image hyperstack (XYC)? (1=yes, 0=no)
...
TF_Analysis = 1; %Will do TF translocalization analysis (1=yes, 0=no)
CH_TF = 4; %Which channel corresponds to transcription factor (TF) signal?

aSMA_Analysis = 1; %Will do gradient-based aSMA analysis (1=yes, 0=no)
CH_aSMA = 2; %Which channel corresponds to aSMA signal?
aSMA_ImageSave = 1; %Do you want to save an image of the aSMA channel and gradient image? (1=yes, 0=no)
...
%%The number refers to how many nuclei must be detected for a "cell object" to be called a "cluster."
