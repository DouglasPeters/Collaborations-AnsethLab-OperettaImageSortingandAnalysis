...
if Ch2_Analysis == 1,
    ...
    Ch2_NEARFAR_MEANS.IntDen(f-ff) = sum(Ch2_medd,'all');
else end
...
if Ch3_Analysis == 1,
    ...
    Ch3_NEARFAR_MEANS.IntDen(f-ff) = sum(Ch3_medd,'all');
else end
...
if Ch4_Analysis == 1,
    ...
    Ch4_NEARFAR_MEANS.IntDen(f-ff) = sum(Ch4_medd,'all');
else end
...
elseif ShowImages == 0 && WriteImages == 0 && f-ff==1,
    ...
    Folder_Outputs = append(Folder,'DilationAnalysis/s');
    cd(Folder_Outputs);
else cd(Folder_Outputs);
end 
