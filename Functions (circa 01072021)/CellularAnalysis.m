...
NoNucFilter(m,1) = size(Results_CellAnalysis(m).NuclearProps,1)>0;
end

Results_CellAnalysis = Results_CellAnalysis(NoNucFilter); %Only CellMask objects containing 1 or more DAPI objects will pass this filter. This removes cells on the very edges of images, as well as fragments of CellMask signal within images.
